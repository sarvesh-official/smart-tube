...
const SideBar = ({ isOpen }: { isOpen: boolean }) => {
  ...
  return (
    <>
      {isOpen === true ? (
        <>
          <div className="flex-1 rounded-bl-lg bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-3xl bg-opacity-20">
              ...
              {playlists.map((playlist) => (
                <div
                  ...
                  onClick={() => {
                    ...
                    router.push(`/playlistVideos/${playlist.id}`)
                  }}
                >
                  <Image
                    src={
            ...
            <div className="flex flex-col gap-5">
              {playlists.map((playlist) => (
                ...
                >
                  ...
                  {/* Tooltip */}
                  <div className="absolute bottom-[-35px] z-30 left-1/2 transform -translate-x-1/2 w-full px-2 py-1 rounded-md bg-gray-800 text-white text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300">
